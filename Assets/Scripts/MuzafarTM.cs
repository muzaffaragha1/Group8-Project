...
namespace Assets
{
    public class MuzafarTM : MonoBehaviour
    {
        ...
        int charpos;
        int myPos;
        public MrunTM turing;
        public char changeChar;
        public float pos = 0f;
        // public Animator anim;
        MuzafarTM1 state = new MuzafarTM1();
        ...
        public void getString()
        {
            ...
            bool validate = re.validatInputM(myString);
            ...
            else
            {
                ...
                turing = new MrunTM(state.add(), language, state.currentstate);
        ...
        public void executeTM()
        {
            if (turing.current_st() != null)
            {
                ...
                readAlphabet.text = "Read: " + turing._readChar().ToString();
                writeAlphabet.text = "Write: " + changeChar.ToString();
                ...
                print(this.transform.position = new Vector3((charpos * 2.5f) + 2.5f, 0, -4));
                counter = counter + 1;
            ...
            if (turing.current_st() == "q8" && turing.last_Move() == Move.H)
            {
                Destroy(arrow);
                states.text = "CURRENT STATE : Accept";
                msg.text = "String accepted successfully";
            }
            else if (turing.current_st() != "q8" && turing.last_Move() == Move.H)
            {
                Destroy(arrow);
