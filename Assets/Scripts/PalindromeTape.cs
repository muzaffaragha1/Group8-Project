...
namespace Assets
{
    public class PalindromeTape : MonoBehaviour
    {
        ...
        public RunPalindrome turing;
        public char changeChar;
        public float pos = 0f;
        // public Animator anim;
        PalindromeTransitionTbl state = new PalindromeTransitionTbl();
        ...
        public void getString()
        {
            ...
            bool validate = re.validatInputP(myString);
            ...
            else
            {
                ...
                turing = new RunPalindrome(state.add(), language, state.currentstate);
        ...
        public void executeTM()
        {
            if (turing.current_st() != null)
            {
                ...
                //arrow.transform.position = new Vector3((charpos * 2.5f) + 2.5f, -1.214f, 0.015f);
            ...
            if (turing.current_st() == "q7" && turing.last_Move() == Move.H)
            {
                //Destroy(arrow);
                states.text = "CURRENT STATE : Accept";
                msg.text = "String accepted successfully";
            }
            else if (turing.current_st() != "q7" && turing.last_Move() == Move.H)
            {
                //Destroy(arrow);
